...
class IndexController extends BaseController {
    ...
    public function formSubmit() {
        ...
        $this->msg = $this->postMail ($body, $subject, 'Enquiry@BuyBusiness.com.hk', '2757144278@qq.com');
    ...
    public function SellersQuery() {
        ...
        $body = '姓名: '.$name.'<br/>電郵: '.$email.'<br/>電話號碼: '.$tel.'<br/>意見: '.$suggest.'<br/>最方便之聯絡時間: '.$contact_date.'<br/>接收最新資訊: '.$accept;
        $this->msg = $this->postMail ($body, $subject, 'Sell.Biz@BuyBusiness.com.hk', '2757144278@qq.com');
    ...
    public function contactSubmit() {
        ...
        $this->msg = $this->postMail ($body, $subject, 'CS@BuyBusiness.com.hk', '2757144278@qq.com');
    ...
    public function AjaxSearch() {
        ...
        if (null !== $keyword && !empty($keyword)) {
            $map['_complex'] = array (
                'title_'.$this->lang => array ('like', "%{$keyword}%"),
                'codename_'.$this->lang => array ('like', "%{$keyword}%"),
                '_logic' => 'or'
            );
        }
